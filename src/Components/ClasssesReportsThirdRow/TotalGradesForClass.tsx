...
const TotalGradesForClass = ({ experiments }) => {
  ...
  const data = {
    ...
    datasets: [
      {
        label: getTranslation('studentsCount'),
        data: [
