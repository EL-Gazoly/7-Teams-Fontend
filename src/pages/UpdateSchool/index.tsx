        ...
        <div className='w-full h-[655px] bg-white dark:bg-[#252A33] rounded-lg flex items-center justify-center'>
            <div className="flex flex-col gap-y-9 items-center justify-center">
                <div className=' flex flex-col gap-y-8'>
                  ...
                  {selectedImage ? <img src={selectedImage} alt="Selected" className=' w-full h-full object-cover rounded-full' /> : <img src={ SchoolIcon} alt="Placeholder" />}
                  </div>
                ...
                <Button className=' w-[217px] h-16 mt-6 rounded-md' onPress={handleUpdateSchool}>
                  <img src={AddIcon} alt="" />
