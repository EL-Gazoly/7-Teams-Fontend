      ...
      <TableBody>
        {
            data.map((student, index) => (
                ...
                <TableCell className='flex items-center justify-center cursor-pointer' onClick={()=> navigate(`/library/students/${student?.studentId}}`)}>
                ...
                <TableCell className=' cursor-pointer'onClick={()=> navigate(`/library/students/${student?.studentId}}`)} >
