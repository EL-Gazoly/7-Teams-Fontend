...
const ChooseGrade = (props) => {
  ...
  const [selectedOption, setSelectedOption] = useState(props.selectedTeam);

  const options = [
    { value: 'High', label: getTranslation('highGrade'), image: GroupIcon },
    { value: 'Middle', label: getTranslation('middleGrade'), image: GroupIcon },
    { value: 'Primary', label: getTranslation('primaryGrade'), image: GroupIcon },
  ];

  const handleChange = (selectedOption) => {
    setSelectedOption(selectedOption);
    props.setSelectedTeam(selectedOption.value);
  };
  ...
  useEffect(() => {
    ...
    if (props.selectedTeam) {
      setSelectedOption(options.find((option) => option.value === props.selectedTeam));
    }
  }, [props.selectedTeam]);
  ...
  return (
    <div className="App">
      <Select
        options={options}
        styles={customStyles}
        placeholder={getTranslation('chooseGrade')}
