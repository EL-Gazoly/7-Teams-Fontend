    ...
    boxShadow: '0px 3.588px 13.454px 0px rgba(91, 89, 89, 0.25)'
              ...
              <div className=' flex flex-col items-center justify-center w-full gap-y-2'>
                  ...
                  <div className="flex flex-col gap-y-1 items-center text-text-black text-center ">
                    <span className=' text-[22px] font-bold'> احمد حامد </span>
                    <span className=' text-xs '>Meta Quest</span>

                  </div>
                  <div className=' flex flex-col mt-7 items-center gap-y-[14px]'>
                    <div className="flex items-center gap-x-1">
                      <div className=' w-[34px] h-3 rounded bg-[#F4F2F2]' />
                      <div className=' w-[34px] h-3 rounded bg-[#2DEC4C]' />
                      <div className=' w-[34px] h-3 rounded bg-[#2DEC4C]' />
                    </div>
                    <span className=' text-text-black text-lg font-semibold'> 76 % </span>
